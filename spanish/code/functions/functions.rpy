translate spanish strings:
    ...
    new "Has desbloqueado un nuevo personaje en la Tablón de Investigación"

    # game/code/functions.rpy:57
    old "You have updated a new in the Investigation Board"
    new "Ha actualizado una novedad en el Tablón de Investigación"

    # game/code/functions.rpy:95
    old "You have unlocked a new connection in the Investigation Board"
    new "Ha desbloqueado una nueva conexión en el tablón de investigación"
